...
$capabilities = array(
    ...
    'enrol/paypalrequest:config' => array(
        'captype' => 'write',
    ...
    'enrol/paypalrequest:manage' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/paypalrequest:unenrol' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW,
    ...
    'enrol/paypalrequest:unenrolself' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
        )
    ...
    'enrol/paypalrequest:enabledisable' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'manager' => CAP_ALLOW
