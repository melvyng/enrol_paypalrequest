...
$PAGE->set_url('/enrol/paypalrequest/disableenrollment.php', array('ue'=>$ueid, 'ifilter'=>$filter));
...
$message = get_string('disableenrollmentconfirm', 'enrol_paypalrequest', array('user'=>fullname($user, true), 'course'=>format_string($course->fullname)));
$fullname = fullname($user);
$title = get_string('disableenrollment', 'enrol_paypalrequest');
